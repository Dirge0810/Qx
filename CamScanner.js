...
[rewrite_local]
^https:\/\/.*\.(intsig\.net|camscanner\.com) url script-response-body https://raw.githubusercontent.com/Dirge0810/Qx/main/CamScanner.js
...
Dirge.data["psnl_vip_property"] = (vip);
Dirge.data["fax_balance"] = "99999";
Dirge.data["used_points"] = "99999";
Dirge.data["points"] = "99999";
Dirge.data["pdfword_balance"] = "100010";
Dirge.data["bookmode_balance"] = 100010;
Dirge.data["immt_expy_points"] = "99999";
Dirge.data["ocr_balance"] = 99999;
Dirge.data["no_login_ocr_balance"] = "99999";
Dirge.data["CamScanner_RoadMap"] = 100000;
}

if ($request.url.indexOf(vipb) != -1){
Dirge.data.ar_property["psnl_vip_property"] = (vip);
}
